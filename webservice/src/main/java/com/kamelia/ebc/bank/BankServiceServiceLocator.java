...
public class BankServiceServiceLocator extends org.apache.axis.client.Service implements com.kamelia.ebc.bank.BankServiceService {
    ...
    public com.kamelia.ebc.bank.BankService getBankService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.kamelia.ebc.bank.BankServiceSoapBindingStub _stub = new com.kamelia.ebc.bank.BankServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.kamelia.ebc.bank.BankService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.kamelia.ebc.bank.BankServiceSoapBindingStub _stub = new com.kamelia.ebc.bank.BankServiceSoapBindingStub(new java.net.URL(BankService_address), this);
                _stub.setPortName(getBankServiceWSDDServiceName());
                return _stub;
            }
        }
