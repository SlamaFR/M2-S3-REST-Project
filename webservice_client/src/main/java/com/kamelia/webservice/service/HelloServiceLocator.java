...
public class HelloServiceLocator extends org.apache.axis.client.Service implements com.kamelia.webservice.service.HelloService {
    ...
    private java.lang.String Hello_address = "http://localhost:8080/WebServiceTest/services/Hello";
    ...
    public com.kamelia.webservice.service.Hello getHello(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.kamelia.webservice.service.HelloSoapBindingStub _stub = new com.kamelia.webservice.service.HelloSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.kamelia.webservice.service.Hello.class.isAssignableFrom(serviceEndpointInterface)) {
                com.kamelia.webservice.service.HelloSoapBindingStub _stub = new com.kamelia.webservice.service.HelloSoapBindingStub(new java.net.URL(Hello_address), this);
                _stub.setPortName(getHelloWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://service.webservice.kamelia.com", "HelloService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://service.webservice.kamelia.com", "Hello"));
        }
